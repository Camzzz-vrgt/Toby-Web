(() => {
  ...
  const GAME_ID = "undertale-spamton";
  const BUILD_ID = "gamebanana-707315-utspamton-butterscotch-2026-09-05a";
  const DATA_PARTS = [1, 2, 3, 4, 5, 6].map((part) => `data.win.part${part}`);
  const LOCAL_AUDIO = ["spamton_meeting.ogg"];
